        ...
        <div class="container">
            ...
            <div class="primary-nav">
                ...
                <form class="main-form" action="{{ url('search-products') }}" method="get">
                    ...
                    <input class="input-text input-text--border-radius input-text--style-1" type="text" id="main-search" name="query" placeholder="Search">
                    ...
                    <div class="ah-lg-mode">
                        ...
                        <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                            ...
                            <li data-tooltip="tooltip" data-placement="left" title="Contact">
                                <a href="tel:+233 244491803"><i class="fas fa-phone-volume"></i></a>
                            </li>
                            <li data-tooltip="tooltip" data-placement="left" title="Mail">
                                <a href="mailto:info@rhodelitconsult.com"><i class="far fa-envelope"></i></a>
                            </li>
                        </ul>
                        <!--====== End - List ======-->
                    </div>
    ...
    <nav class="secondary-nav-wrapper">
        <div class="container">
            ...
            <div class="secondary-nav">
                <!--====== Dropdown Main plugin ======-->
                <?php /* </div><div class="menu-init" id="navigation1">
                ...
                <div class="menu-init" id="navigation2">
                    ...
                    <div class="ah-lg-mode">
                        ...
                        @endforeach
                        <li>
                            <a href="shop-side-version-2.html">FEATURED PRODUCTS</a>
                        </li>
                        </ul>
                        <!--====== End - List ======-->
                    </div>
