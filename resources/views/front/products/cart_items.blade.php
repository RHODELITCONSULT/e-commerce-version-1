                        ...
                        <table class="table-p">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- <span class="table-p__price">GHC{{$item['product']['final_price']* $item['product_qty']}}</span> -->
                                        <div class="pd-detail__inline getAttributePrice">
			                                <span class="pd-detail__price" style="font-size:16px;">GHC{{$getAttributePrice['final_price'] * $item['product_qty']}}</span>
			                                @if($getAttributePrice['discount']>0)
			                                	<span class="pd-detail__discount">({{$getAttributePrice['discount_percent']}}% OFF)</span><del class="pd-detail__del">GHC{{$getAttributePrice['product_price'] * $item['product_qty']}}</del>
			                            @endif
			                        </div>
                                    </td>
                                    <td>
