        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="form-group col-md-6">
              ...
              <input type="checkbox"  name="cms_pages[edit]" value="1" @if(isset($editCMSPages)) {{ $editCMSPages }} @endif>&nbsp;View/EditAccess &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="form-group col-md-6">
              ...
              <input type="checkbox"  name="categories[edit]" value="1" @if(isset($editCategories)) {{ $editCategories }} @endif>&nbsp;View/EditAccess &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="form-group col-md-6">
              ...
              <input type="checkbox"  name="products[edit]" value="1" @if(isset($editProducts)) {{ $editProducts }} @endif>&nbsp;View/EditAccess &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="form-group col-md-6">
              ...
              <input type="checkbox"  name="brands[edit]" value="1" @if(isset($editBrands)) {{ $editBrands }} @endif>&nbsp;View/EditAccess &nbsp;&nbsp;&nbsp;&nbsp;
