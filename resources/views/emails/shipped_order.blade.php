                                    ...
                                    <td style="padding-top: 30px;">
                                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: center;">
                                            <tbody>
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                        Download Order Invoice at <a href="{{ url('dowmload-order-pdf-invoice/'.$order_id.'') }}">{{ url('dowmload-order-pdf-invoice/'.$order_id.'') }}</a><br>
                                                        (Copy & Paste tp,open if link does not work)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                ...
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                        ...
                                                        <a href="mailti:info@rhodelitconsult.com">
                                                        info@rhodelitconsult.com</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666;">
